...
<template>
  <section class="page-stack">
    <div class="list-card">
      <div class="toolbar">
        <label style="max-width: 220px"><span>搜索</span><input v-model="keyword" class="input" placeholder="标题/内容" @keyup.enter="page = 1; load()" /></label>
        <label style="max-width: 130px"><span>类型</span><select v-model="typeFilter" class="select" @change="page = 1; load()">
          <option value="">全部类型</option>
          <option value="announcement">公告</option>
          <option value="task">任务</option>
          <option value="system">系统</option>
        </select></label>
        <label style="max-width: 130px"><span>优先级</span><select v-model="priorityFilter" class="select" @change="page = 1; load()">
          <option value="">全部优先级</option>
          <option value="normal">普通</option>
          <option value="important">重要</option>
          <option value="urgent">紧急</option>
        </select></label>
        <label style="max-width: 130px"><span>状态</span><select v-model="statusFilter" class="select" @change="page = 1; load()">
